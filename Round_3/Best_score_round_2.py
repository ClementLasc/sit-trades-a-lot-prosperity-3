    ...
    def run(self, state: TradingState) -> tuple[dict[str, list[Order]], int, str]:
        ...
        for product in other_products:
            ...
            """ if product == "SQUID_INK" :
                ...
                window = 20 if product =="PICNIC_BASKET1" else 8
                ...
                trade_volume = 10 if product == "SQUID_INK" else 10 
            ...
            if product == "KELP" or product =="RAINFOREST_RESIN" or product =="PICNIC_BASKET1":
